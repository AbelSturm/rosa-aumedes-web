        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((t, i) => (
              <div
                key={i}
                className="bg-card rounded-xl p-6 shadow-sm border border-stone-100 flex flex-col gap-3"
              >
                <svg
                  className="w-6 h-6 text-acento/30 flex-shrink-0"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
                  <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
                </svg>
                <p className="font-inter text-stone-600 text-sm leading-relaxed italic flex-1 line-clamp-5">
                  {t.text}
                </p>
                <div className="pt-2 border-t border-stone-100">
                  <p className="font-playfair font-semibold text-texto text-sm">
                    {t.name}
                  </p>
